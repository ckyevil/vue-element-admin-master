<template>
  <div class="components-container">
    ...
    <!-- <el-col :span="6"> -->
        ...
        <!-- </el-card> -->
      <!-- </el-col> -->
      <h1 class="text-shadow" data-shadow="dang!">INHERENT SCRIPT</h1> 
    ...
    <div class="white-rectangle">
      ...
      <div class="select">
        <el-select v-model="listQuery.type1" placeholder="请选择固有脚本" clearable  style="width: 150px">
          <el-option label="ALEXNET" value="option1"></el-option>
          <el-option label="DENSENET_121" value="DENSENET_121"></el-option>
          <el-option label="RESTNETI8" value="option3"></el-option>
      </el-select>
      </div>
      <div class="select2">
        <el-select v-model="listQuery.type2" placeholder="请选择设备" clearable  style="width: 150px">
          <el-option label="CPU" value="option4"></el-option>
          <el-option label="CUDA" value="option3"></el-option>
...
.el-select .el-input__inner {
  border-color: #ff9900; /* 设置下拉框边框颜色为橙色 */
}
.select3{
  margin-bottom: 20px;
}
